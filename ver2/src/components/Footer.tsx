...
export function Footer() {
  ...
  return (
    <>
      <footer
        ref={footerRef}
        className="border-t border-grafite/10 px-6 py-10 text-sm text-grafite/70 md:px-12"
      >
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 text-center md:flex-row md:justify-between md:text-left">
          <div className="space-y-1">
            <p>B&amp;B Dimora Kekka — C/DA Frasso, 84, 87064 Corigliano Rossano (CS)</p>
            <p>
          ...
          <a
            ...
            aria-label="Pagina Facebook di B&B Dimora Kekka"
            className="flex h-9 w-9 items-center justify-center rounded-full text-grafite/70 transition-colors hover:text-terracotta"
          >
